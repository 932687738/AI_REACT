...
export const API_PATHS = {
  agentHub: {
    ...
    flows: '/api/agent-hub/flows',
    flow: (id: number) => `/api/agent-hub/flows/${id}`,
    flowPublish: (id: number) => `/api/agent-hub/flows/${id}/publish`,
    flowRegisterMcp: (id: number) => `/api/agent-hub/flows/${id}/register-mcp-tool`,
    flowEnable: (id: number) => `/api/agent-hub/flows/${id}/enable`,
    flowDisable: (id: number) => `/api/agent-hub/flows/${id}/disable`,
    flowVersions: (id: number) => `/api/agent-hub/flows/${id}/versions`,
    flowRollback: (id: number) => `/api/agent-hub/flows/${id}/rollback`,
    flowDebug: (id: number) => `/api/agent-hub/flows/${id}/debug`,
    flowExecutions: '/api/agent-hub/flow-executions',
    flowExecution: (executionId: number) => `/api/agent-hub/flow-executions/${executionId}`,
  },
  superAgents: {
    ...
    agentFlow: (name: string) => `/api/super-agents/agents/${encodeURIComponent(name)}/flow`,
