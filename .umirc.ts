  ...
  routes: [
    { path: '/share/:shareId', component: './share/$shareId', layout: false },
    {
      ...
      routes: [
        ...
        { path: '/agent-hub/flow-management', component: './flow-management' },
        { path: '/agent-hub/flow-executions', component: './flow-executions' },
        { path: '/agent-hub/flow-executions/:executionId', component: './flow-executions/detail' },
        { path: '/agent-hub/flow-designer/:flowId', component: './flow-designer' },
